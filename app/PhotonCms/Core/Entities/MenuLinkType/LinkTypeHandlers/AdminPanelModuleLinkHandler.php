...
class AdminPanelModuleLinkHandler extends BaseLinkHandler implements LinkTypeHandlerGetDataInterface, LinkTypeHandlerCompileLinkInterface
{
    ...
    {
        $data = $this->parseResourceData($data);
        return "localhost/module/".$data['table_name'];
    }
