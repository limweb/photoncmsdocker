...
class SingleEntryTemplate extends DynamicModuleModelTemplate
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->addImplementation('Photon\PhotonCms\Core\Entities\DynamicModule\Contracts\SingleEntryInterface');
